    ...
    <div className="flex items-center justify-center min-h-[80vh] animate-in fade-in zoom-in duration-300">
      <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md border border-gray-100">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm mt-2">Chào mừng bạn quay lại hệ thống</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          <div>
            <label className="block text-sm font-semibold text-gray-700 mb-1.5 flex items-center gap-1.5">
              <Phone className="w-4 h-4 text-gray-400" /> Tài khoản (SĐT hoặc Email)
            </label>
            <input
              type="text"
              required
              ...
              placeholder="09xx xxx xxx hoặc admin@gmail.com"
            />
          </div>
          ...
          >
            {loading ? <div className="w-5 h-5 border-2 border-white/30 border-t-white rounded-full animate-spin"></div> : 'Đăng nhập'}
          </button>
        </form>

        <div className="mt-6 p-4 bg-blue-50 text-blue-800 text-sm rounded-xl flex justify-between items-center border border-blue-100 shadow-sm">
          <div>
            <p className="font-bold mb-1">Tài khoản Admin Demo:</p>
            <p>TK: <span className="font-mono">admin@gmail.com</span></p>
            <p>MK: <span className="font-mono">admin123</span></p>
          </div>
          <button 
            type="button" 
            onClick={() => { setPhone('admin@gmail.com'); setPassword('admin123'); }}
