...
graph TD
    ...
    C <--> |Goi API| D
    B -.-> |Cho 3s, tu dong mo| F[Trinh duyet Web<br>localhost:5173]
    F --> |Hien thi UI| C
"""
...
image_path = os.path.join(os.getcwd(), 'diagram.png')
...
p_img = doc.add_paragraph('Hình 4.1: Sơ đồ kiến trúc và cơ chế khởi chạy Local Automation')
...
filepath = os.path.join(os.getcwd(), 'Phan_4_1_1_Co_Hinh_Anh.docx')
doc.save(filepath)
